...
Import `automation/n8n/bugfix-webhook-demo.json` (not the old chat workflow).
...
| `Unrecognized node type: langchain` | Import **bugfix-webhook-demo.json** instead of chat demo |
